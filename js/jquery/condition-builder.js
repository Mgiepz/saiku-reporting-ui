...
var rootcondition = '<table><tr><td class="seperator" ><img src="images/src/delete.png" alt="Remove" class="remove" /><select><option value="and">And</option><option value="or">Or</option></select></td>';
rootcondition += '<td><div class="querystmts"></div><div><img class="add" src="images/src/add.png" alt="Add" /> <button class="addroot">+()</button></div>';
rootcondition += '</td></tr></table>';

var statement = '<div><img src="images/src/delete.png" alt="Remove" class="remove" />'

statement += '<select class="agg">';
statement += '<option value="code">Sum of</option>';
statement += '<option value="country">Avg of</option>';
statement += '<option value="capital"></option>';
statement += '</select>';

statement += '<select class="col">';
statement += '<option value="code">Territory</option>';
statement += '<option value="country">Country</option>';
statement += '<option value="capital">Price Sold</option>';
statement += '<option value="govt">Product Scale</option>';
statement += '<option value="cont">Order Amount</option>';
statement += '</select>';

statement += '<select class="op">';
statement += '<option value="contains">LIKE</option>';
statement += '<option value="startswith">BEGINS WITH</option>';
statement += '<option value="endswith">ENDS WITH</option>';
statement += '<option value="doesnotcontain">CONTAINS</option>';
statement += '<option value="doesnotstartwith">DOES NOT CONTAIN</option>';
statement += '<option value="national">EQUALS</option>';
statement += '<option value="area">LESS THAN</option>';
statement += '<option value="pop">LESS THAN OR EQUALS</option>';
statement += '<option value="gdp">MORE THAN</option>';
statement += '<option value="g8">MORE THAN OR EQUALS</option>';
