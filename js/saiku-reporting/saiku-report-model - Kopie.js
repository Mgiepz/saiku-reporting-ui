[23:58]	_roland	var ClassName;
[23:58]	_roland	(ClassName = function(){ ...this is the constructor....}).prototype = {...this is the "class declaration"...};
...
var ReportSpecification = {
	...
	setElementFormatPropertyById: function(xmlId, property, value){
		...
		switch (uid.type){
			case "phd":
			path = ["pageHeaders",uid.index2,"format",property];
			break;
			case "pft":
			path = ["pageFooters",uid.index2,"format",property];
			break;
			case "rhd":
			path = ["reportHeaders",uid.index2,"format",property];
			break;
			case "rft":
			path = ["reportFooters",uid.index2,"format",property];
			break;
			case "ghd":
			path = ["groupDefinitions",uid.index1,"headerFormat",property];
			break;
			case "gft":
			path = ["groupDefinitions",uid.index1,"footerFormat",property];
			break;
			case "dth":
			path = ["groupDefinitions",uid.index2,"headerFormat",property];
			break;
			case "dtl":
			//return this.fieldDefinitions[uid.index2][{rowGrp:null,colGrp:null}]; //?
			break;				
